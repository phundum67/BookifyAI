    ...
    <div className="stack settings-page">
      ...
      <section className="card stack settings-section-card">
        ...
        {favorites.length ? (
          ...
          <p className="muted">Save businesses to find them again quickly.</p>
        )}
      </section>
      ...
      <section className="card stack settings-section-card">
        ...
        {bookings.length ? (
          ...
          <p className="muted">Your booking history will show up here.</p>
        )}
      </section>
      ...
      <section className="settings-info-grid">
        <article className="card settings-info-card">
          <div className="section-heading">
            <h3>Payments</h3>
            <span className="badge badge-solid">Placeholder</span>
          </div>
          <p className="muted">Payment methods and invoices can be added here in a future version.</p>
        </article>
        <article className="card settings-info-card">
          <div className="section-heading">
            <h3>Policies</h3>
          </div>
          <p className="muted">Booking cancellations, reviews, and app usage rules will live here.</p>
        </article>
        <article className="card settings-info-card">
          <div className="section-heading">
            <h3>About us</h3>
