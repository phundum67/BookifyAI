  ...
  return (
    <div className="page-wrap stack detail-page-v2">
        ...
        <div className="detail-cover-media">
          ...
          <div className="detail-cover-actions">
            <button className="detail-icon-button" type="button" onClick={toggleFavorite}>
              {business.is_favorite ? "Saved" : "Save"}
            </button>
            <button className="detail-icon-button" type="button" disabled>
              Share
            </button>
          </div>
        </div>
      ...
      <section className="card stack detail-rules-card">
        <div className="section-heading">
          <h2>Booking rules</h2>
          <span className="badge badge-solid">V2 ready</span>
        </div>
        <p className="muted">Instant booking is confirmed when generated slots are available. Cancellation rules and reminders can be expanded in a future version.</p>
      </section>
        ...
        <form className="card stack booking-panel" onSubmit={handleBooking}>
          ...
          {isConfirming ? (
            <div className="booking-confirm-box">
              ...
              <p className="muted small-text">We will reserve the selected generated slot instantly if it is still available.</p>
            </div>
          ) : null}
      ...
      <section className="card stack review-section-v2">
        ...
        <div className="review-preview-grid">
          {reviewPreview.length ? (
            ...
            <p className="muted">Reviews from booked customers will appear here.</p>
          )}
        </div>
