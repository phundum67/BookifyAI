    ...
    <div className="stack settings-page business-settings-page">
      ...
      <section className="settings-info-grid">
        <article className="card settings-info-card">
          ...
          <p className="muted">Support chat, business FAQs, and owner guides can be added here in a future version.</p>
        </article>
        <article className="card settings-info-card">
          <div className="section-heading">
            <h3>Policies</h3>
          </div>
          <p className="muted">Booking rules, cancellation policies, review rules, and business terms will live here.</p>
        </article>
        <article className="card settings-info-card">
          <div className="section-heading">
            <h3>About us</h3>
